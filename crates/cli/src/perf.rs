...
// # Writes JSON lines:
// # {"schema":"aegis-perf/v1","kind":"duration","run_id":"...","frame":1234,"ts_ms":1739599900793,"metric":"chat::render","duration_ms":2.345,"extra":{"key":"msgs","value":42}}
// ```
...
mod enabled {
    ...
    const PERF_SCHEMA: &str = "aegis-perf/v1";
