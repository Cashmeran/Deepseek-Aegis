...
use super::super::{App, InvalidationLevel, MessageBlock};
...
pub(crate) fn has_focused_question(app: &App) -> bool {
    focused_question(app).is_some()
}

pub(crate) fn focused_question_is_editing_notes(app: &App) -> bool {
...
pub(crate) fn execute_question_action(
    app: &mut App,
...
pub(crate) fn handle_question_note_key(app: &mut App, key: KeyEvent) -> Option<KeyOutcome> {
    normalize_pending_interaction_queue(app);
