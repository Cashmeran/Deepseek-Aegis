...
use super::super::connect::begin_resume_session;
use super::super::events::push_system_message_with_severity;
use super::super::view;
use super::super::{App, AppStatus, SystemSeverity};
...
mod tests {
    ...
    use crate::bridge::wire::{BridgeCommand, CommandEnvelope};
