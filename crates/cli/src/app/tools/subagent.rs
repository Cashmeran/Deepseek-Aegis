...
use super::super::{AUTOCOMPLETE_VISIBLE_ROWS, App, FocusTarget};
use super::super::interaction::dialog::DialogState;
...
fn filter_candidates(
    candidates: &[crate::bridge::model::AvailableAgent],
    query: &str,
...
mod tests {
    ...
    fn sync_with_cursor_activates_when_subagent_token_is_valid() {
        ...
        app.available_agents = vec![
            crate::bridge::model::AvailableAgent::new("reviewer", "Review code"),
            crate::bridge::model::AvailableAgent::new("explore", "Explore codebase"),
        ];
    ...
    #[ignore = "CC feature not yet wired in aegis"]
    #[test]
