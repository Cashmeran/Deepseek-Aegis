...
use super::super::{App, TodoItem, TodoStatus};
...
#[cfg(test)]
pub(crate) fn parse_todos(raw_input: &serde_json::Value) -> Vec<TodoItem> {
...
pub(crate) fn apply_plan_todos(app: &mut App, plan: &model::Plan) {
