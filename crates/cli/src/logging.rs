...
const BRIDGE_LOG_SCHEMA: &str = "aegis-log/v1";
const BRIDGE_LINE_PREVIEW_LIMIT: usize = 240;
const DEFAULT_LOG_DIR: &str = "deepseek-aegis";
const DEFAULT_LOG_FILE_NAME: &str = "aegis.log";
const DEFAULT_PERF_FILE_NAME: &str = "aegis-perf.log";
...
mod tests {
    ...
    fn parses_structured_bridge_diagnostic() {
        let line = r#"{"schema":"aegis-log/v1","timestamp":"2026-04-08T12:00:00Z","level":"warn","target":"bridge.sdk","event_name":"sdk_spawn_failed","message":"spawn failed","session_id":"session-1","fields":{"preview":"node"}}"#;
    ...
    fn resolve_log_path_uses_default_when_filter_enables_logging() {
        ...
        assert!(path.ends_with("deepseek-aegis/logs/aegis.log"));
    }
    ...
    fn resolve_perf_path_uses_default_when_enable_perf_is_set() {
        ...
        assert!(path.ends_with("deepseek-aegis/logs/aegis-perf.log"));
    }
