...
const SETTINGS_LIMITATION_HINT: &str = "Currently, not all settings are supported by aegis. This project uses the official Anthropic Claude Agent SDK, which limits claude-rs implementing all Claude Code settings.";
...
mod tests {
    ...
    fn normal_layout_renders_settings_limitation_hint() {
        ...
        assert!(rendered.contains("supported by aegis"));
