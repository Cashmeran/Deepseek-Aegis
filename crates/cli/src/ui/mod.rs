...
//! Original UI componentry (autocomplete, tool call rendering, inline chat, etc).
//! Used by `app/` through the library. Not used by the `tui/` render path
//! (`tui/` is aegis's own render layer).
